...

{
  programs.hyprpanel = {
    ...
    settings = {
      ...
      "menus.clock.weather.location" = "Kyiv";
      ...
      "menus.clock.weather.key" = "23846ddad7d248c4a2a231826253006";
      ...
      "theme.bar.dropdownGap" = "2.25em";
      "bar.workspaces.monitorSpecific" = false;
      "bar.customModules.cpu.icon" = "󰻠";
      ...
      "menus.dashboard.shortcuts.left.shortcut1.command" = "firefox-dev";
